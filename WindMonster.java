...
public class WindMonster extends Monster
{
    ...
    {
        super(name, new Sprite(x, y, 3, "MonsterSprites\\WindMonster Idle 1.png", "MonsterSprites\\WindMonster Idle 2.png", "MonsterSprites\\WindMonster Moving 1.png", "MonsterSprites\\WindMonster Moving 2.png"));
    }
